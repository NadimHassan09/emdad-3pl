...
export class InboundOrdersService {
  ...
  /** List orders for one client (client portal); ignores any clientId on filter. */
  findManyForClientPortal(clientId: string, filter?: InboundOrderFilterDto) {
